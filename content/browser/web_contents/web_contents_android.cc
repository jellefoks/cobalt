...
void WebContentsAndroid::UpdateWebContentsVisibility(JNIEnv* env,
  ...
  LOG(FATAL) << "WebContentsAndroid::UpdateWebContentsVisibility should never be called in Cobalt.";
#else
...
#if BUILDFLAG(IS_COBALT)
  LOG(FATAL) << "WebContentsAndroid::OnFreeze should never be called in Cobalt.";
#else
...
#if BUILDFLAG(IS_COBALT)
  LOG(FATAL) << "WebContentsAndroid::OnResume should never be called in Cobalt.";
#else
...
#if BUILDFLAG(IS_COBALT)
  LOG(FATAL) << "WebContentsAndroid::SuspendAllMediaPlayers should never be called in Cobalt.";
#else
...
#if BUILDFLAG(IS_COBALT)
  LOG(FATAL) << "WebContentsAndroid::SetFocus should never be called in Cobalt.";
#else
  WebContentsViewAndroid* view =
      static_cast<WebContentsViewAndroid*>(web_contents_->GetView());
